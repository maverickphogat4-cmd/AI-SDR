  ...
  useEffect(() => {
    ...
    try {
      renderer = new Renderer({
        ...
        antialias: true,
        // Capped at 1.5, not the vendor default of 2 -- same reasoning as
        // every other continuously-rendering react-bits canvas in this
        // project (Topography, Ferrofluid): retina DPR isn't worth it for
        // an ambient/decorative canvas.

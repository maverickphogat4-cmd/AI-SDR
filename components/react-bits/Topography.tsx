...
const Topography: React.FC<TopographyProps> = ({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({
      ...
      antialias: false,
      // Capped at 1.5 (not the vendor default of 2) -- this runs constantly
      // as a full-page dashboard background, so retina-DPR cost isn't worth
      // it here (same reasoning as the landing page's ColorBends background).

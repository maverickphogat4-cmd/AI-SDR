    ...
    <div className="flex flex-col rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-2 border-t border-zinc-800 pt-4">
        <button
          ...
          onClick={handleCopy}
          disabled={!isDone}
          className="rounded-full border border-zinc-700 px-4 py-1.5 text-xs font-medium text-zinc-300 transition-colors hover:border-zinc-500 hover:text-white disabled:cursor-not-allowed disabled:opacity-40"
        >
          {copied ? "Copied" : "Copy"}
        </button>
        <button
          ...
          disabled={!isDone}
          className="rounded-full border border-teal-700/60 px-4 py-1.5 text-xs font-medium text-teal-300 transition-colors hover:border-teal-500 hover:text-teal-200 disabled:cursor-not-allowed disabled:opacity-40"
        >
          Simulate reply
        </button>
        <button
